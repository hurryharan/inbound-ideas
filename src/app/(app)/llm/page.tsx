    ...
    <form onSubmit={submit} className="mt-4 space-y-3 rounded-lg border border-neutral-200 bg-white p-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <label className="text-sm">
          ...
          <input required value={defaultModel} onChange={(e) => setDefaultModel(e.target.value)} className="mt-1 w-full rounded-md border border-neutral-300 px-2 py-1.5" />
        </label>
      </div>
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      <div className="mt-6 space-y-3">
        ...
        {providers?.map((p) => (
          <div key={p.id} className="flex items-center justify-between rounded-lg border border-neutral-200 bg-white p-4">
            <div>
